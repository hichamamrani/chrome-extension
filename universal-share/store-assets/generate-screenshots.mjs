...
const shots = [
  { file: 'screenshot-1-main.png', params: 'caption=Share+any+page+like+on+mobile' },
  { file: 'screenshot-2-dark-mode.png', params: 'theme=dark&caption=Beautiful+dark+mode+support' },
  { file: 'screenshot-3-share-targets.png', params: 'view=grid&caption=WhatsApp%2C+Telegram%2C+X%2C+LinkedIn+and+more' },
];
  ...
  await page.setContent(`
    <html><body style="margin:0;background:#eff6ff;">
      <img src="data:image/png;base64,${fullBuffer.toString('base64')}"
           style="width:880px;height:550px;object-fit:cover;object-position:right center;margin-left:-260px;margin-top:-50px;">
    </body></html>
  `);
